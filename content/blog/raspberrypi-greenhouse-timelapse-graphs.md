...
This year I've combined the two hobbies, and used it as an excuse to have a play with the [Pimoroni GROW kit](https://shop.pimoroni.com/products/grow?variant=32208365486163), a breakout board for the Raspberry Pi which does soil moisture monitoring and can do automatic watering.  With thanks to John and Steve, I got my hands on a pair of Pi Zeros (blasted global chip shortage, they are rare as hens teeth right now.)  I ended up using two, a Zero and a ZeroW2 because I struggled to get the Zero to connect to my WiFi (I'll write that up separately - fascinating Heisenbug).
